...
<head>
    ...
    <script type="text/javascript" defer>            
        ...
        {
            $.ajax({
                url: "<?php echo base_url('chart_controller/score_table');?>",
                method: "POST",
                dataType: "JSON",
                success: function(data)
                {
        ...
        {
            $.ajax({
                url: "<?php echo base_url('chart_controller/score_last_week_rate');?>",
                method: "POST",            
                dataType: "JSON",
                success: function(data)
                {
    ...
    {
    $.ajax({
            url: "<?php echo base_url('chart_controller/score_last_month_rate');?>",
            method: "POST",            
            dataType: "JSON",
            success: function(data)
            {
    ...
    {
    $.ajax({
            url: "<?php echo base_url('chart_controller/score_last_year_rate');?>",
            method: "POST",            
            dataType: "JSON",
            success: function(data)
            {
    ...
    {
        $.ajax({
            url: "<?php echo base_url('chart_controller/score_data');?>",
            method: "POST",            
            dataType: "JSON",
            success: function(data)
            {
    ...
    function scorechart(chart_data)
        {
...
<script defer src="<?php echo base_url();?>js/hide_divs.js"></script>
