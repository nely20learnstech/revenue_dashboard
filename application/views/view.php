...
<head>
    ...
    <script type="text/javascript" defer>
        ...
        {
            $.ajax({
                url: "<?php echo base_url('display_slug/fetch_store_data/') . $store["slug"];?>",
                method: "POST",
                dataType: "JSON",
        ...
        {
            $.ajax({
                url: "<?php echo base_url('display_slug/last_week_rate/') . $store["slug"];?>",
                method: "POST",            
                dataType: "JSON",
                success: function(data)
                {
        ...
        {
        $.ajax({
                url: "<?php echo base_url('display_slug/last_month_rate/') . $store["slug"];?>",
                method: "POST",            
                dataType: "JSON",
                success: function(data)
                {
        ...
        {
        $.ajax({
                url: "<?php echo base_url('display_slug/last_year_rate/') . $store["slug"];?>",
                method: "POST",            
                dataType: "JSON",
                success: function(data)
                {
        ...
        {
            $.ajax({
                url: "<?php echo base_url('display_slug/actual_revenue/') . $store["slug"];?>",
                method: "POST",            
                dataType: "JSON",
                success: function(data)
                {
