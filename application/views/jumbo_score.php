...
<head>
    ...
    <script type="text/javascript">
        ...
        setInterval(function()
                {
                    $.ajax({
                        url: "<?php echo base_url('chart_controller/jumboScore_table');?>",
                        method: "POST",
                        dataType: "JSON",
                        success: function(data)
                        {
                            jumboScore_table(data);
                        },
                        error: function(error)
                        {
                            console.log(error);
        ...
        function jumboScore_table(tableData)
        {
            var store_data = '';
            store_data +=   `
                                <table>
        ...
        {
            $.ajax({
                url: "<?php echo base_url('chart_controller/jumbo_score_last_week_rate');?>",
                method: "POST",            
                dataType: "JSON",
                success: function(data)
                {
    ...
    {
    $.ajax({
            url: "<?php echo base_url('chart_controller/jumbo_score_last_month_rate');?>",
            method: "POST",            
            dataType: "JSON",
            success: function(data)
            {
    ...
    {
    $.ajax({
            url: "<?php echo base_url('chart_controller/jumbo_score_last_year_rate');?>",
            method: "POST",            
            dataType: "JSON",
            success: function(data)
            {
    ...
    {
        $.ajax({
            url: "<?php echo base_url('chart_controller/jumboScore_data');?>",
            method: "POST",            
            dataType: "JSON",
            success: function(data)
            {
    ...
    function last_year_rate(sales)
    {
        ...
        google.charts.setOnLoadCallback(jumboScore_chart);

        function jumboScore_chart(chart_data)
        {
...
<section class="sidebar">
    ...
    <div id="revenue_value">
        ...
        <span class="money_change" id="money_change"></span><i>Ar</i>
